...
var roleFlagRepairer = {
    ...
    run: function(creep) {
        ...
        if(flag && flag.color == COLOR_GREEN && flag.secondaryColor == COLOR_WHITE){
                ...
                if(creep.room == flag.room){
                    ...
                    if(creep.memory.targetToRepair != 0){
                        creep.travelTo(Game.getObjectById(creep.memory.targetToRepair));
                    }else if(creep.memory.targetToBuild != 0){
                        creep.travelTo(Game.getObjectById(creep.memory.targetToBuild));
                    }else{
            ...
            AssignNewFlag.run(creep, COLOR_GREEN, COLOR_WHITE);
...
module.exports = roleFlagRepairer;
